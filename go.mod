module github.com/tvanderpool/flux-manifest-generator

go 1.26.0

replace github.com/tvanderpool/flux-manifest-generator/api => ./api

// Replace digest lib to master to gain access to BLAKE3.
...
require (
	...
	github.com/tvanderpool/flux-manifest-generator/api v0.0.0-00010101000000-000000000000
